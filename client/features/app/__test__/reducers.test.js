...
describe('app reducer test', () => {
  test('test APP_SET_API_ROOT', () => {
    ...
    const {apiRoot}=reducer(intialSt,appSetApiRoot(appModelFixutre.apiRoot))
    expect(apiRoot).toEqual(appModelFixutre.apiRoot)
    console.log(appModelFixutre.apiRoot)
  })
  ...
  test('test APP_RESET', () => {
    ...
    const {apiRootValid,isInitialized,apiRoot}=reducer(intialSt,appReset())
    expect(apiRootValid).toEqual(false)
  ...
  test('test APP_SET_STORE_ID', () => {
    ...
    const {storeID}=reducer(intialSt,appSetStoreId(appModelFixutre.storeID))
