describe('The Delivery Link', () => {
  ...
  describe('Click on delete for deleting records', () => {
    it('click on delete for Delivery', () => {
      cy
        .get('.grommetux-anchor')
        .contains('Delivery')
        .click()
  ...
  describe('Click on Cancel button', () => {
    it('click on cancel for Delivery', () => {
      cy
        .get('.grommetux-anchor')
        .contains('Delivery')
        .click()
  ...
  describe('Click on search button to add record. Check for duplicate', () => {
    it('click on update for Delivery', () => {
      cy
        .get('.grommetux-anchor')
        .contains('Delivery')
        .click()
  ...
  describe('Click on change quantity', () => {
    it('click on change quantity for Delivery', () => {
      cy
        .get('.grommetux-anchor')
        .contains('Delivery')
        .click()
